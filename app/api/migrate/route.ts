...
export async function GET(req: Request) {
  ...
  const migrations = [
    ...
    `ALTER TABLE health_daily ADD COLUMN IF NOT EXISTS lean_bm NUMERIC(8,4)`,
    `ALTER TABLE health_daily ADD COLUMN IF NOT EXISTS body_fat NUMERIC(6,3)`,
    `ALTER TABLE health_daily ADD COLUMN IF NOT EXISTS bmi NUMERIC(6,3)`,
